...
function init(botLogoPath) {
    ...
    template = ` <button class='chat-btn'><img width="30" height="30" src="https://img.icons8.com/dotty/80/cyber-security.png" class = "material-icon" ></button>
    ...
    <div class='chat-popup'>
		...
		<div class='chat-header'>
			...
			<button class = "expand-chat-window" ><img width="24" height="24" src="https://img.icons8.com/material-outlined/24/full-screen--v1.png" class="material-icon" ></button>
		</div>
    ...
    chatBtn.addEventListener("click", () => {
        ...
        if (chatPopup.style.display == "none" && mobileDevice) {
            ...
            chatInput.focus();
            chatBtn.innerHTML = `<img width="24" height="24" src="https://img.icons8.com/ios-filled/50/delete-sign--v1.png" class = "material-icon" >`
        } else if (mobileDevice) {
            chatPopup.style.display = "none"
            chatBtn.innerHTML = `<img width="24" height="24" src="https://img.icons8.com/dotty/80/cyber-security.png"class = "material-icon" >`
        } else {
            mobileView()
        }
    })

    document.getElementById("chatBot").addEventListener("click", (event) => {
        ...
        if (chatPopup.style.display === "none" || chatPopup.style.display === "") {
            ...
            chatPopup.style.display = "none";
            chatBtn.innerHTML = `<img width="30" height="30" src="https://img.icons8.com/dotty/80/cyber-security.png" class="material-icon">`;
        }
    });
